...
<%
    if ((request.getParameter("passdb").equals(request.getParameter("passworda"))) && (request.getParameter("password").equals(request.getParameter("passwordc")))) {
        ...
        try {
            ...
            stmt = conexion.prepareStatement("UPDATE usuarios SET pass=MD5(?) WHERE id_usuario=?");
...
<html>
    ...
    <body>
        <h1 style="text-align:center;color:black" class="text-success">The user's password was successfully updated</h1>
        <br></br>
        ...
        <a class="btn btn-outline-info" href="index.jsp" role="button">Back</a>
        <a class="btn btn-outline-danger" href="formularioEditaContra.jsp" role="button">Try again</a>
    </body>
</html
<%}%>
